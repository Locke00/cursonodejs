...
sessionsRouter.post("/login", isValidPassword, async (req, res, next) => {
  try {
    ...
    //if (email && password === "hola12345") {
    if (email) {    //aqui ya no tengo q hacer la verificacion de contraseña hardcoreada
        //xq estoy usando isValidPassword, q valida x mongo la contraseña

  ...
  new LocalStrategy(
    ...
    async (req, email, password, done) => {
      ...
      try {
        ...
        if (one) {
          done(null, false, {messages: "already exists", statusCode: 400}); //si el usuario existe no puedo re-registrarlo, x lo tanto la estrategia termina aca
        } else {
          let data = req.body;
      ...
      try {
        ...
        if (user) {
          ...
          if (verify) {
            ...
            done(null, false, {messages: "bad auth from passport cb"});
          }
        } else {
